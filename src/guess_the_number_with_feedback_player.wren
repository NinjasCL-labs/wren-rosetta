// url: https://rosettacode.org/wiki/Guess_the_number/With_feedback_(player)#Wren
// source: https://rosettacode.org/mw/index.php?title=Guess_the_number/With_feedback_(player)&action=edit&section=68
// file: guess_the_number_with_feedback_player
