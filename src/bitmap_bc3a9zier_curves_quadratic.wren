// url: https://rosettacode.org/wiki/Bitmap/B%C3%A9zier_curves/Quadratic#Wren
// source: https://rosettacode.org/mw/index.php?title=Bitmap/B%C3%A9zier_curves/Quadratic&action=edit&section=30
// file: bitmap_bc3a9zier_curves_quadratic
