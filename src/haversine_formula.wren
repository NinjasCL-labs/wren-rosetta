// url: https://rosettacode.org/wiki/Haversine_formula#Wren
// source: https://rosettacode.org/mw/index.php?title=Haversine_formula&action=edit&section=107
// file: haversine_formula
