// url: https://rosettacode.org/wiki/Variable-length_quantity#Wren
// source: https://rosettacode.org/mw/index.php?title=Variable-length_quantity&action=edit&section=39
// file: variable_length_quantity
