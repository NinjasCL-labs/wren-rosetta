// url: https://rosettacode.org/wiki/Regular_expressions#Wren
// source: https://rosettacode.org/mw/index.php?title=Regular_expressions&action=edit&section=120
// file: regular_expressions
