// url: https://rosettacode.org/wiki/Move-to-front_algorithm#Wren
// source: https://rosettacode.org/mw/index.php?title=Move-to-front_algorithm&action=edit&section=50
// file: move_to_front_algorithm
