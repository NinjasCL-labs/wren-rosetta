// url: https://rosettacode.org/wiki/Angles_(geometric),_normalization_and_conversion#Wren
// source: https://rosettacode.org/mw/index.php?title=Angles_(geometric),_normalization_and_conversion&action=edit&section=25
// file: angles_geometric_normalization_and_conversion
// name: Angles (geometric), normalization and conversion
// author: PureFox
// license: MIT
