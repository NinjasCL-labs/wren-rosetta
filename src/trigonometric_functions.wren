// url: https://rosettacode.org/wiki/Trigonometric_functions#Wren
// source: https://rosettacode.org/mw/index.php?title=Trigonometric_functions&action=edit&section=104
// file: trigonometric_functions
