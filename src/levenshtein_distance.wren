// url: https://rosettacode.org/wiki/Levenshtein_distance#Wren
// source: https://rosettacode.org/mw/index.php?title=Levenshtein_distance&action=edit&section=136
// file: levenshtein_distance
